...
async function fetchGorexStats() {
  try {
    ...
    const [
      health, slot, blockHeight, epochInfo, version, txCount, blockhash,
      genesisHash, identity, supply, inflationRate, leaderSchedule,
      performance, voteAccounts, blockTime, blockProduction, clusterNodes,
      minRentExemption, programAccounts, feeForMessage, recentPrioritizationFees,
      highestSnapshotSlot, slotLeader, recentBlock,
    ] = await Promise.all([
